...
const NAV = [
  ...
  { href: "/admin/cache",          label: "Cache",         enabled: true,  iconPath: "M4 7v10c0 2 4 4 8 4s8-2 8-4V7M4 7c0 2 4 4 8 4s8-2 8-4M4 7c0-2 4-4 8-4s8 2 8 4" },
  { href: "/admin/content",        label: "Content",       enabled: true,  iconPath: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  { href: "/admin/engine",         label: "Engine",        enabled: true,  iconPath: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065zM15 12a3 3 0 11-6 0 3 3 0 016 0z" },
  { href: "/admin/system",         label: "System",        enabled: true,  iconPath: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
];
      ...
      <div className={`relative ${collapsed ? "px-2" : "px-5"} pt-5 pb-4 border-b border-slate-100 dark:border-slate-800`}>
        {!collapsed ? (
          <div className="flex flex-col items-center w-full">
            <img src="/admin-logo.png" alt="528 AI" className="w-12 h-12 mb-2 rounded-lg" />
            <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 tracking-wide uppercase">Admin Console</p>
          </div>
        ) : (
          <div className="flex justify-center">
            <img src="/admin-logo.png" alt="528 AI" className="w-9 h-9 rounded-lg" />
          </div>
        )}
        <button
